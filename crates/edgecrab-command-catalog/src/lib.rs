...
pub const BUILTIN_SLASH_COMMANDS: &[SlashCommandSpec] = &[
    ...
    SlashCommandSpec {
        name: "memory",
        aliases: &["mem"],
        description: "Memory store and write-approval governance",
        category: "Memory & Skills",
        args_hint: "[pending|approve|reject|approval on|off]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
        name: "snapshot",
        aliases: &["snap"],
        description: "Quick config/state snapshots (create, list, restore)",
        category: "Config",
        args_hint: "[list|create [label]|restore <id>|prune [N]]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
        ...
        category: "Config",
        args_hint: "[mode manual|smart|off]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
    ...
    SlashCommandSpec {
        name: "kanban",
        aliases: &["kb"],
        description: "Multi-agent task board (list, create, claim, complete, boards)",
        category: "Advanced",
        args_hint: "[list|triage|create|decompose|show|block|subscribe|boards|claim|complete]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
