...
- copy OpenClaw skills into `~/.edgecrab/skills/openclaw-imports/`
- optionally copy the OpenClaw workspace instructions file into a chosen Hermes workspace
- mirror compatible workspace assets such as `workspace/tts/` into `~/.edgecrab/tts/`
...
- `~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py`

Do not guess a shorter path like `~/.edgecrab/skills/openclaw-migration/...`.

Before running the helper:

1. Prefer the installed path under `~/.edgecrab/skills/migration/openclaw-migration/`.
...
```bash
python3 ~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py
```
...
```bash
python3 ~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --preset user-data
```

Execute a user-data migration:

```bash
python3 ~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python3 ~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python3 ~/.edgecrab/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
...
- OpenClaw skills available under `~/.edgecrab/skills/openclaw-imports/`
