...
MIGRATION_OPTION_METADATA: Dict[str, Dict[str, str]] = {
    ...
    "skills": {
        "label": "User skills",
        "description": "Copy OpenClaw skills into ~/.edgecrab/skills/openclaw-imports/.",
    },
    "tts-assets": {
        "label": "TTS assets",
        "description": "Copy compatible workspace TTS assets into ~/.edgecrab/tts/.",
    },
    "discord-settings": {
...
class Migrator:
    ...
    def generate_migration_notes(self) -> None:
        ...
        notes.extend([
            ...
            "- Review `~/.edgecrab/config.yaml` for any adjustments",
            "",
        ])
...
def main() -> int:
    ...
    if args.execute:
        print()
        print("  Next steps:")
        print("    1. Review ~/.edgecrab/config.yaml")
