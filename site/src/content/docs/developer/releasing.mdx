...
It waits until the specific crate version is actually visible on crates.io, then keeps a short stabilization buffer before moving to the next dependent crate.
